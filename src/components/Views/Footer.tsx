    ...
    <div className="pt-[8rem] pb-[4rem] bg-[#02050a]">
      <div className="grid border-b-[1px] pb-[6rem] border-gray-400 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-[80%] mx-auto gap-[3rem] ">
        <div className="flex items-center space-x-4">
          ...
          <div className="">
            <h1 className="text-white text-[25px] mb-[0.2rem] font-semibold ">
              Address
            </h1>
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="">
            <h1 className="text-white text-[20px] mb-[0.2rem] font-semibold ">
              Send
            </h1>
            <p className="text-[17px] w-[90%] text-white opacity-60">
              example.com <br /> example@gmail.com
            </p>
          </div>
        </div>
      </div>
